...
export const api = {
  ...
  dashboard: {
    ...
    // Прогноз кассовых разрывов: неоплаченные счета по неделям вперёд (на
    // основе due_date) с простой оценкой риска по Trust Score контрагентов.
    cashflowForecast: () => req('/dashboard/cashflow-forecast'),
  },
